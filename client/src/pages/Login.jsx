  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-b from-blue-50 to-white">
      <div className="w-full max-w-sm px-8 py-12">
        ...
        {/* 이메일 로그인 폼 (토글) */}
        {showEmailForm && (
          <form onSubmit={handleLogin} className="mt-6 space-y-4 animate-fadeIn">
            <div>
              <input
                type="email"
                name="email"
            ...
            <button
              type="submit"
              className="w-full py-3 font-semibold text-white bg-blue-500 rounded-xl hover:bg-blue-600 transition-colors shadow-sm hover:shadow-md"
            >
              로그인
            </button>
          </form>
        ...
        <div className="relative my-8">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="px-4 text-gray-400 bg-gradient-to-b from-blue-50 to-white">또는</span>
          </div>
        </div>
        ...
        <div className="flex justify-center gap-4">
          ...
          <button
            ...
            className="w-12 h-12 flex items-center justify-center bg-white border-2 border-gray-200 rounded-full hover:border-gray-300 hover:shadow-md transition-all"
            title="Google 로그인"
          >
